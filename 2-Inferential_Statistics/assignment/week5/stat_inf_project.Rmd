...
Based on the one-variable contingency table above, higher proportions of people in 2002 tend to be against homosexual sexual relationships.
...
conclerg_homosex <- gss_clean %>%
  ...
  summarize(freq = n()) %>%
  pivot_wider(id_cols=homosex, names_from=conclerg, names_prefix='conclerg: ', values_from=freq)
