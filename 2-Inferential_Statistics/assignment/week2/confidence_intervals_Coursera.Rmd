...
<li> __The sample distribution must be nearly normal.__ </li>
</ol>
...
<li> __95% of random samples of size 60 will yield confidence intervals that contain the true average area of houses in Ames, Iowa.__ </li>
...
__Why?__: If we take many samples and compute 95% confidence interval for each sample then about 95% of those confidence intervals will have true population mean.
...
__Answer:__ 92% of the confidence intervals include the true population mean. This is not exactly equal to the confidence level of 95% we selected earlier. This is because the confidence level is just an approximation and an exact measure would be difficult to obtain.
...
# 0.995 will give us the appropriate critical value for a 99% confidence level
